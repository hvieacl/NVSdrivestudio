"""Check and extract Waymo semantic masks for OmniRe training."""
...
def parse_cameras(value: Optional[str]) -> List[int]:
    if not value:
...
def build_parser() -> argparse.ArgumentParser:
    ...
    check_parser.add_argument("--cameras", default=DEFAULT_CAMERAS)
