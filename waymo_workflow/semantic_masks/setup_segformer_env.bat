...
echo        waymo_workflow\semantic_masks\download_segformer_checkpoint.bat
if "%DOWNLOAD_SEGFORMER_CHECKPOINT%"=="1" call waymo_workflow\semantic_masks\download_segformer_checkpoint.bat
