...
if "%AUTO_PREPARE_SMPL_MODEL%"=="1" set "ARGS=%ARGS% --auto_prepare_smpl_model"
conda run -n "%ENV_NAME%" python waymo_workflow\human_pose\cli.py check --data_root "%DATA_ROOT%" --scene_ids "%SCENE_IDS%" --smpl_model "%SMPL_MODEL%" %ARGS%
