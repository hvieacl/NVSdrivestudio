...
```bash
conda run -n drivestudio python waymo_workflow/human_pose/cli.py prepare-smpl-model
```
...
```bash
bash waymo_workflow/human_pose/setup_4dhumans_env.sh
SCENE_IDS="114" bash waymo_workflow/human_pose/extract_waymo_humanpose.sh
```
